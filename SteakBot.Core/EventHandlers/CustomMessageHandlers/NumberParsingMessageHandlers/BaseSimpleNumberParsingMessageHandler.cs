...
{
    /// <summary>
    /// Contains the logic for parsing numbers with a leading identifier in the format "identifier#123".
    /// </summary>
    internal abstract class BaseSimpleNumberParsingMessageHandler : BaseNumberParsingMessageHandler
    {
        protected override string RegexMatchPattern { get; } = "(^|[^a-zA-Z0-9])({keyword}#[0-9]+)";
