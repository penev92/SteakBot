...
namespace SteakBot.Core.Modules
{
    public class QuoteModule : ModuleBase<SocketCommandContext>
    {
        ...
        private readonly IQuoteModuleConfiguration _configuration;

        public QuoteModule(QuotingService quotingService, IQuoteModuleConfiguration configuration)
        {
        ...
        public async Task Quote([Remainder]string message)
        {
            ...
            if (userRoles == null || !userRoles.Select(x => x.Name).Intersect(_configuration.TrustedRoles).Any())
            {
